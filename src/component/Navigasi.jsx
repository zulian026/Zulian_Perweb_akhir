...
function Navigasi() {
  return (
    <Navbar expand="lg" className="bg-body">
      <Container>
        <Navbar.Brand href="/Zulian_Perweb_akhir/">
          Ngoding<span>Bareng.</span>
        </Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            <Nav.Link href="/Zulian_Perweb_akhir/" className="nav-item">
              <svg
            ...
            <Nav.Link href="/Zulian_Perweb_akhir/Contact" className="nav-item">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
            ...
            <Nav.Link href="/Zulian_Perweb_akhir/About" className="nav-item">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
